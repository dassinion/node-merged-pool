...
var generateOutputTransactions = function(poolRecipient, recipients, rpcData, metaData){
...
exports.CreateGeneration = function(rpcData, publicKey, extraNoncePlaceholder, reward, txMessages, recipients, auxMerkleTree, metaData){
    ...
    var txComment = txMessages === true ?
        util.serializeString('https://github.com/dassinion/node-merged-pool-sd') :
        new Buffer([]);
    ...
    var outputTransactions = generateOutputTransactions(publicKey, recipients, rpcData, metaData);
